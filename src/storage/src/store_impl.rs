...
use crate::store::LocalStateStoreReadLog;
...
mod dyn_state_store {
    ...
    pub type BoxLocalStateStoreReadChangeLogIter = BoxStateStoreIter<'static, StateStoreReadLogItem>;
    ...
    pub trait DynLocalStateStore:
        DynStateStoreGet + DynStateStoreWriteEpochControl + DynLocalStateStoreReadLog + StaticSendSync
    {
        async fn iter(
            &self,
            key_range: TableKeyRange,
    ...
    #[async_trait::async_trait]
    impl<S: LocalStateStore + LocalStateStoreReadLog> DynLocalStateStore for S {
        async fn iter(
            &self,
            key_range: TableKeyRange,
            read_options: ReadOptions,
    ...
    impl LocalStateStoreReadLog for BoxDynLocalStateStore {
        ...
        fn iter_uncommitted_log(&self) -> impl Future<Output = StorageResult<Self::ChangeLogIter>> + Send + '_ {
